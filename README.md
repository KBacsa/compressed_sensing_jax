...
$$\theta^\star = \arg \min_{\theta} \parallel \Phi(\Psi(\theta)) - \Phi(x) \parallel_2^2 + \lambda \parallel \theta \parallel_1$$  
...
Example using Discrete Cosine Transform with 10% of samples. 
